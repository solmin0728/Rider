...
struct U3CPrivateImplementationDetailsU3E_t60D390955C994A4CAC0539E533ED349C64C34EF4_StaticFields
{
	...
	__StaticArrayInitTypeSizeU3D6474_t78181D72425FD49D7ABD7D01FABD263F71260BEC ___F75BD4133250099BE3005F261AE52DD81E049A02CA888114680C3EC0E02D923C;
};
...
IL_0183_1:
			{
				...
				if ((((int32_t)((*(int32_t*)UnBox(L_49, il2cpp_defaults.int32_class)))) < ((int32_t)0)))
				{
					goto IL_01b8_1;
				}
			}
			...
			}
			{
				...
				bool L_53;
				L_53 = SystemInfo_SupportsRenderTextureFormat_mCCC3C69578A2C5B7367F73999E6938C315A98201(((*(int32_t*)UnBox(L_52, RenderTextureFormat_tB6F1ED5040395B46880CE00312D2FDDBF9EEB40F_il2cpp_TypeInfo_var))), NULL);
				V_2 = L_53;
				...
				bool L_56 = V_2;
				Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48(L_54, ((*(int32_t*)UnBox(L_55, il2cpp_defaults.int32_class))), L_56, Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48_RuntimeMethod_var);
			}
...
IL_01f4_1:
			{
				...
				if ((((int32_t)((*(int32_t*)UnBox(L_69, il2cpp_defaults.int32_class)))) < ((int32_t)0)))
				{
					goto IL_0230_1;
				}
			}
			...
			}
			{
				...
				bool L_73;
				L_73 = SystemInfo_SupportsTextureFormat_m833B0ABED13B5B8D0D4BCF082F3EFA51A3B5C860(((*(int32_t*)UnBox(L_72, TextureFormat_t87A73E4A3850D3410DC211676FC14B94226C1C1D_il2cpp_TypeInfo_var))), NULL);
				V_5 = L_73;
				...
				bool L_76 = V_5;
				Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48(L_74, ((*(int32_t*)UnBox(L_75, il2cpp_defaults.int32_class))), L_76, Dictionary_2_set_Item_m266E81996A1E6BFCB7C91E78EC0DB1253655AD48_RuntimeMethod_var);
			}
